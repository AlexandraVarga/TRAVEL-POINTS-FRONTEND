...
import { addAttraction, deleteAttraction } from "../../services/AttractionsService";
...
export default function CreateTouristAttractionForm() {
  const {
    register,
    handleSubmit,
    watch,
  ...
  const handleInsert = (data) => {
    ...
    addAttraction(attractionDto)
      .then((response) => {
        console.log(response);
        if (response.status === 200) {
          Swal.fire("Success!", "Tourist attraction created successfully!", "success").then(
            function () {
